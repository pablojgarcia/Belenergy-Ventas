...
class DraftService:
    ...
    def create(self, customer_id: Optional[int] = None, notes: Optional[str] = None, lines_data: Optional[list] = None, new_client_name: Optional[str] = None, new_client_vat: Optional[str] = None, new_client_industry: Optional[str] = None, new_client_is_company: Optional[bool] = None, terms_and_conditions_id: Optional[uuid.UUID] = None) -> models.QuotationDraft:
        if customer_id:
        ...
        draft = models.QuotationDraft(
            ...
            new_client_industry=new_client_industry,
            new_client_is_company=new_client_is_company,
    ...
    def update(
        ...
        new_client_industry: Optional[str] = None,
        new_client_is_company: Optional[bool] = None,
        ...
        draft.new_client_industry = new_client_industry
        draft.new_client_is_company = new_client_is_company
